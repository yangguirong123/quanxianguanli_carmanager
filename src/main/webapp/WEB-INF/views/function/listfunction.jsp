...
<body>
	...
	<p>
		[<a href="<%=contextPath %>/module/listmodule.do">返回模块浏览</a>]
	</p>

	<p style="color: red;">模块名称：${module.modulename}</p>
		...
		<c:forEach items="${moduleFunctionList}" var="x">
			...
			<tr>
				...
				<td bgcolor="#FFFFFF"><div align="center">
						<a
							href="javascript:void _delete('<%=contextPath %>function/deletemodulefunction.do?function_id=${x.function_id}','功能')">删除</a>
					</div></td>
				<td bgcolor="#FFFFFF"><div align="center">
						<a href="#">修改</a>
					</div></td>
	...
	<h3>添加功能到当前模块</h3><span style="color: red">${mmm}</span><hr>
	
	<form action="<%=contextPath %>/addmodulefunction.do" name="form1" method="post"
