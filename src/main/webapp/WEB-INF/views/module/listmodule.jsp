		...
		<c:forEach items="${modulesList}" var="x">
			...
			<tr>
				...
				<td bgcolor="<%=color %>"><div align="center">
						<a 
							href="javascript:void _delete('deletemodule.do?module_id=${x.module_id}','模块')">删除</a>
					</div></td>
				<td bgcolor="<%=color %>"><div align="center">
						<a href="<%=contextPath %>#?module_id=${x.module_id}">修改</a>
					</div></td>
				<td bgcolor="<%=color %>"><div align="center">
						<a href="<%=contextPath %>/function/listfunction.do?module_id=${x.module_id}">模块功能管理</a>
					</div></td>
			</tr>
		</c:forEach>
