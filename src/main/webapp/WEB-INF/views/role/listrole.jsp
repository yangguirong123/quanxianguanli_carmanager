...
<body>
	...
	<table width="100%%" border="0" cellpadding="2" cellspacing="2"
		...
		<c:forEach items="${roleLists}" var="x">
			...
			%>
		<tr>
			<td bgcolor="<%=color %>"><div align="center">${x.rolename}</div></td>
			<td bgcolor="<%=color %>" style="word-break: break-all;"><div
					align="center">${x.description}</div></td>
			<td bgcolor="<%=color %>"><div align="center">
					[<a
						href="javascript:void _delete('deleterole.do?role_id=${x.role_id}','角色')">删除</a>]
					[<a href="modifyrole.jspa?id=${x.role_id}">修改</a>] [<a
